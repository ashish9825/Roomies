...
import com.example.ashishpanjwani.rommies.Models.User;
import com.example.ashishpanjwani.rommies.Utils.Constants;
...
public class LoginActivity extends BaseActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private void createUserInFirebaseHelper() {
        ...
        final String encodedEmail = RoomieUtil.encodeEmail(email.toLowerCase());
    ...
    public void onClick(View v) {
        ...
        RoomieUtil util = new RoomieUtil(this);
        int id = v.getId();
